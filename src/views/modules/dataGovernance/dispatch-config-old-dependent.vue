<template>
  <el-dialog :close-on-click-modal="false" width="1000px" :append-to-body="true" title="新增依赖" :visible.sync="visible" @close="closed">
    <el-row :gutter="20">
      <el-col :span="11">
        <el-card class="box-card" shadow="never">
          ...
          <el-table ref="multipleLeftTable" :data="leftTableData" border @selection-change="handleLeftSelectChange">
      ...
      <el-col :span="11">
        <el-card class="box-card" shadow="never">
          ...
          <el-table ref="multipleRightTable" :data="rightTableData" border @selection-change="handleRightSelectChange">
            <el-table-column header-align="center" align="center" type="selection" width="55"></el-table-column>
            <el-table-column header-align="center" align="center" prop="etlJobName" label="任务名称"></el-table-column>
