  ...
  <el-tabs v-model="activeName" @tab-click="handleClick">
    <el-tab-pane label="缩短网址" name="first">
      <el-form :model="dataForm" :inline="true" ref="dataForm"  label-width="80px">
        <el-form-item  prop="url">
          <el-input v-model.trim="dataForm.key" placeholder="原始链接" style="width: 550px"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-tab-pane label="网址还原" name="second">
      <el-form :model="secondForm" :inline="true" ref="secondForm"  label-width="80px">
        <el-form-item  >
          <el-input v-model.trim="secondForm.key" placeholder="短链接" style="width: 550px"></el-input>
        </el-form-item>
        <el-form-item>
