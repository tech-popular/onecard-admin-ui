<template>
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    ...
    <el-form-item label="任务" prop="project">
      <el-input v-model="dataForm.project" placeholder="任务"/>
    </el-form-item>
    <el-form-item label="任务名称" prop="serviceName">
      <el-input v-model="dataForm.serviceName" placeholder="任务名称"/>
    </el-form-item>
    <el-form-item label="任务" prop="group">
      <el-input v-model="dataForm.group" placeholder="任务"/>
    </el-form-item>
