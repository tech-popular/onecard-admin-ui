<template>
    <div class="aviator">
      ...
      <el-table-column prop="datasourceName" header-align="center" align="center" label="数据库名字"/>
      <el-table-column prop="keyspaceName" header-align="center" align="center" label="键空间名称"/>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag v-if="scope.row.enable === true" size="small" >启用</el-tag>
