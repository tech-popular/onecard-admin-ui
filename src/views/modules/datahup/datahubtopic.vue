...
<script>
  import AddOrUpdate from './datahubtopic-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList (id) {
        this.visible = true
        this.dataForm.projectId = id
        this.dataListLoading = true
        this.$nextTick(() => {
          this.$http({
            url: this.$http.adornUrl('/datahup/datahubtopic/list'),
            method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/datahup/datahubtopic/delete'),
            method: 'post',
