  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" v-if="isAuth('honeycomb:honeycombtask:update')" @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
          <el-button type="text" size="small" v-if="isAuth('honeycomb:honeycombtask:delete')" @click="deleteHandle(scope.row.id)">删除</el-button>
          <el-button type="text" size="small" @click="taskProgress(scope.row.id)">进度</el-button>
          <el-button type="text" size="small" v-if="isAuth('honeycomb:honeycombtask:start')" @click="startTask(scope.row.id)">启动任务</el-button>
