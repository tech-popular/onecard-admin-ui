<template>
  <el-dialog
    ...
    <el-form-item label="表名称" prop="tableName">
      <el-input v-model="dataForm.tableName" placeholder="表名称" disabled></el-input>
    </el-form-item>
    <el-form-item label="表的主键" prop="pk">
      <el-input v-model="dataForm.pk" placeholder="表的主键" disabled></el-input>
    </el-form-item>
    <el-form-item label="合并sql" prop="mergeSql">
      <el-input v-model="dataForm.mergeSql" placeholder="合并sql" disabled></el-input>
    </el-form-item>
    <el-form-item label="空间名" prop="maxcomputeSpace">
      <el-input v-model="dataForm.maxcomputeSpace" placeholder="空间名" disabled></el-input>
    </el-form-item>
    ...
    methods: {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/honeycomb/honeycombmaxcomputemergetask/update`),
              method: 'post',
