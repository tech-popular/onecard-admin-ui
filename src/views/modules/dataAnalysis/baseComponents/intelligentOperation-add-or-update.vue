...
<el-drawer
  ...
  <div slot="title" class="drawer-title">{{tag}}<i class="el-icon-close drawer-close" @click="drawerClose"></i></div>
        ...
        <div class="pane-rules">
          ...
          <el-row :gutter="20">
            ...
            <el-row :gutter="20">
              ...
              <el-col style="width: 8.33333%;">
                <el-form-item class="label-remove-margin" prop="transferType">
                    <el-checkbox label="业务下发" v-model="baseForm.issuedType" @change="issuedTypeChage" style="margin-left: 8px;"></el-checkbox>
                </el-form-item>
              </el-col>
              <el-col :span="10">
    ...
    <transfer-log v-if="transferLogVisible" ref="transferLog" :data="transferLogList"></transfer-log>
		<intelligentOperation-message v-if="intelligentOperationMessageVisible" ref="intelligentOperationMessage"></intelligentOperation-message>
  </el-drawer>
</template>
<script>
  ...
  import intelligentOperationMessage from './intelligentOperation-message'
  export default {
    data () {
      // 验证枚举类型的函数
      ...
      return {
        ...
        intelligentOperationMessageVisible: false,
        baseRule: {
          templateId: [
    ...
    components: { Treeselect, transferLog, intelligentOperationMessage },
    ...
    methods: {
      ...
      issuedTypeChage () {},
      issuedServerChange (label) {
        console.log('label: ', label)
        this.intelligentOperationMessageVisible = true
        this.$nextTick(() => {
          this.$refs.intelligentOperationMessage.init()
        })
      },
