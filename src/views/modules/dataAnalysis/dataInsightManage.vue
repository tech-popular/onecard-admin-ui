<template>
  <div>
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" style="width: 100%;" @selection-change="selectionChangeHandle">
      ...
      <el-table-column prop="lastCalTime" header-align="center" align="center" sortable label="最近计算时间" :formatter="lastCalTimeFormat"></el-table-column>
      ...
      <el-table-column prop="createTime" header-align="center" align="center" sortable label="创建时间"></el-table-column>
      <el-table-column prop="creator" header-align="center" align="center" label="创建人"></el-table-column>
      <el-table-column prop="updateTime" header-align="center" align="center" sortable label="最后修改时间"></el-table-column>
      <el-table-column header-align="center" align="center" width="200" label="操作">
        <template slot-scope="scope">
          <el-button
            size="small"
            type="text"
            @click="addOrUpdateHandle(scope.row, 'update')"
          >{{(isAdmin || scope.row.authOtherList.includes(userid || username) || scope.row.authOwner === userid || scope.row.authOwner === username) ? '编辑' : '查看'}}</el-button>
          <el-button
            type="text"
            size="small"
