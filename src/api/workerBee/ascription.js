...
let gf = '/gongFeng'
// 所属系统管理
export const sysManagerList = (params, flag) => httpGet(gf + '/beeSysManager/list', params, flag) // 初始化列表
...
export const saveorupt = (params, id) => id ? httpPut(gf + `/bee/sysManager/save`, params) : httpPost(gf + '/beeSysManager/save', params) // 新增表单提交
