...
export const getSceneWeightList = params => httpPost(base + 'sceneRule/getSceneWeightList', params) // 物品规则
export const selectFirstCategoryName = params => httpPost(base + 'productInfo/selectFirstCategoryName', params) // 第一类别
