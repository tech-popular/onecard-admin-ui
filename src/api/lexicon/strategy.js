...
export const weidushowStrategyDropDown = (params, flag) => httpPost(base + `dimension/selectStrategyDimension/${params}`) // 纬度下拉集合
export const weidushowStrategyDropDownTwo = (params, flag) => httpPost(base + `dimension/selectStrategyDimension/${params}`) // 纬度下拉集合
