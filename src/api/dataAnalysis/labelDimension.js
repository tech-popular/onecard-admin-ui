...
export const addEnum = (params) => httpPost(da + 'dataEnumType/addEnum', params) // 添加枚举类
export const updateEnum = (params) => httpPost(da + 'dataEnumType/updateEnum', params) // 添加枚举类
